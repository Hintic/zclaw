...
public final class SkillService {
    ...
    public static void appendSkillSections(StringBuilder sb, Path workDir, SoulProfile soul) {
        ...
        if (!own.isEmpty()) {
            ...
            sb.append("Shared packs: `.zcode/skills/<pack>/` (all souls). This soul only: `.zcode/souls/");
            sb.append(soul.getId()).append("/skills/<pack>/` (legacy: `.zcode/skills/");
