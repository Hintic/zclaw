...
/**
 * Persists mood score (0–100) per soul under {@code <workDir>/.zclaw/souls/<id>/mood.json}.
 * Legacy {@code <workDir>/.zclaw/soul_mood/<id>.json} is read once and migrated when the new file is absent.
 */
public class SoulMoodStore {

    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
    private static final String LEGACY_DIR = ".zclaw/soul_mood";
    ...
    private Path soulDir(String soulId) {
        return workDir.resolve(".zclaw/souls").resolve(safeName(soulId));
    }
