...
/**
 * Peer messaging for multi-instance collaboration. Uses {@link SoulInboxStore} ({@code .zclaw/souls/<id>/inbox.jsonl}, legacy {@code soul_inbox/}).
 */
public class SoulMailTool implements Tool {
    ...
    public String description() {
        return """
                Exchange short messages with another zclaw instance running in the SAME work directory
